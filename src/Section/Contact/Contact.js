  ...
  return (
    <div className={style.contact} id="contact">
      ...
      <a href="mailto:abhi2k5u@gmail.com" target="_blank">
        ...
        <a href="https://www.facebook.com/profile.php?id=100004129398541" target="_blank">
        ...
        <a href="https://instagram.com/the_heartful_shayari?igshid=YmMyMTA2M2Y=" target="_blank">
        <i className={style.icons4}>
          <BsInstagram />
        </i>
        </a>
        <a href="https://www.linkedin.com/in/abhishek-kumar-586b67143/" target="_blank">
        ...
        <a href="https://app.netlify.com/teams/abhishek-kumar-functionup/overview" target="_blank">
